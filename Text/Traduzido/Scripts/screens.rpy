...
#############################################
    ...
    window:
        ...
        imagebutton:
            ...
            action [Play ("menu_sfx", "sfx/ping.wav"), ShowMenu("load")] xoffset 67 yoffset 559 at menu_eff
        imagebutton:
            idle "ui/mm/null.png"
            ...
            hbox:
                ...
                vbox:
                    ...
                    frame:
                        ...
                        hbox:
                            textbutton _("Diálogos Vistos") action Preference("skip", "seen")
                            textbutton _("Todos Diálogos") action Preference("skip", "all")
                    frame:
                        style_group "echo_pref"
                        xfill True
                        yoffset 30
                        ...
                        hbox:
                            textbutton _("Parar de Pular") action Preference("after choices", "stop")
                            textbutton _("Cont. Pulando") action Preference("after choices", "skip")
                    frame:
                        style_group "echo_pref"
                        xfill True
                        xpadding 80
...
screen quick_menu():
    ...
    hbox:
        ...
        textbutton _("Histórico") action [Play ("ex_sfx", "sfx/click.wav"), ShowMenu("text_history")] 
        textbutton _("Avançar Tudo") action Skip(fast=True, confirm=True)
