...
c "— Sabe, na verdade Eles limpam vários outros Insetos que entram na casa."
m "— É... bem, Eu prefiro ficar coberto em Formigas do que Aranhas."
"Se torna óbvio que ele está tentando não rir de mim, enquanto ele remove a tampa do seu balde."
"Na superfície tem algumas fotos em moldura, e logo abaixo delas, tem mais caixas."
"Eu removo as travas no outro lado do balde, tomando cuidado com qualquer coisa no escuro que possa pular em mim." #(?)
"Esse balde é cheio de feixes, cobertos em tecido ou papel."
"Carl Arrasta seu balde para as escadas, para sentar nelas, e Eu faço o mesmo."
c "— Então, como cê acha que vai usar isso tudo?"
m "— Hum..."
